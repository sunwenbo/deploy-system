...
rds = redis.Redis(host='r-bp1yrn18gzb3ifnpc7.redis.rds.aliyuncs.com', port=6379, password='z6GvSvBNeixR7aZe', socket_timeout=10,db=0)
...
qlist = {
            'queues:account':   10,
            'queues:queue1129': 200,
            'queues:reconciliation': 10,
            'queues:bank-transfer': 10,
            'queues:hts': 10000,
            'queues:share': 10000,
            'queues:bhts': 10000
        }

content = 'Ta Queue blocking: '
